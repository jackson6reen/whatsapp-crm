...
function ClientsDirectory({ 
  ...
  const handleAddNoteInDrawer = (e) => {
    ...
    if (updatedClient) {
      // Small timeout to let state propagate from parent
      setTimeout(() => {
    ...
    <div className="view-container" style={{ position: 'relative' }}>
      ...
      <div className="view-header">
        <div className="view-title">
          ...
          <p>Maintain contact records, log interaction notes, and review timeline histories</p>
        </div>
      ...
      {showSmartParser && (
        <div className="card" style={{ animation: 'fadeIn 0.25s ease' }}>
          ...
          <SmartParser onParseSuccess={(client) => {
            ...
            // Open this client's details drawer immediately
            ...
            {filteredClients.length === 0 ? (
              ...
              filteredClients.map(client => (
                <tr key={client.id}>
                  ...
                  <td>{client.phone}</td>
                  <td>{client.email || <span style={{ color: 'var(--text-muted)' }}>—</span>}</td>
                  <td>
                    <select
      ...
      {selectedClientForTimeline && (
        <>
          ...
          <div 
            style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.4)', zIndex: 850 }}
